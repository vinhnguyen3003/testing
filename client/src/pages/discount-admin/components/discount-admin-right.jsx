...
function DiscountAdminRight() {
    ...
    const handleDatetime = () => {
        ...
        if(Date.now() < Date.parse(datetimeInput.value)){
            ...
            updateCountdownFlashsale(flashsale._id, {countdown: datetimeInput.value});
        }else{
    ...
    const cancelCountdown = () => {console.log("tt")
        ...
        setCountdownArr([]);
        updateCountdownFlashsale(flashsale._id, {countdown: 'null'});
    }
    ...
    //console.log(productAdjust.flashsaleType)
    return (
                ...
                <div className="right-time__content">
                    ...
                    <div className="right-time-content__select">
                        ...
                        <div className="right-time-content-btn">
                            <button 
                                className="btn btn--green time-btn"
                                onClick={handleDatetime}
                            >Kích hoạt</button>
                            <button 
                                className="btn btn--red time-btn"
