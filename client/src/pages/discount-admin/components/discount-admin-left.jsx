...
function DiscountAdminLeft() {
    const {productState: {products}, getProductsByCondition} = useContext(ProductContext);
    ...
    const handleChange = (e) => {
        ...
        storageRef.current = setTimeout(() => {
            getProductsByCondition(15, `flashsale=${filterValue}`, 'null', value.toLowerCase());
        }, 500)
    }
    const handleFilterChange = (index, filterKey) => {
        ...
        getProductsByCondition(15, `flashsale=${filterKey}`, 'null', searchValue.toLowerCase())
    }
    const resetSearchValue = () =>{
        if(searchValue !== ""){
            setSearchValue("");
            getProductsByCondition(15, 'null', 'null', 'null');
        }
    }
    useEffect(() => {
        getProductsByCondition(15, 'null', 'null', 'null');
